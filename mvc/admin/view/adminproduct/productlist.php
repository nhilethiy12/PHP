...
<table class="table">
  ...
  ?>
    <tr>
      ...
      <td><a href ='<?php echo BASE_URL?>adminproduct/productToggleTrash/<?php echo $p["productId"] ?>'onclick='return confirm("Ban co chac chan xoa san pham nay?")'>Xoá</a>|<a href ='<?php echo BASE_URL?>adminproduct/updateproduct/<?php echo $p['productId']?>'>Sửa</a></td>
    </tr>
  <?php }?>
  </tbody>
</table>
